...
pub mod MockContract {
    ...
    pub impl MockContractImpl of super::IMockContract<ContractState> {
        ...
        fn get_member_will_duration_pub(self: @ContractState, member: ContractAddress) -> u64 {
            self.account_data.get_member_will_duration(member)
        }
        fn get_remaining_will_time_pub(self: @ContractState, member: ContractAddress) -> u64 {
            self.account_data.get_remaining_will_time(member)
        }
    ...
    pub impl PrivateImpl of PrivateTrait {
        ...
        fn get_remaining_will_time(self: @ContractState, member: ContractAddress) -> u64 {
            self.account_data.get_remaining_will_time(member)
        }
