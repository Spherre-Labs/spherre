...
fn test_propose_transaction_successful() {
    ...
    // Propose Transaction
    let tx_id = mock_contract.propose_nft_transaction_pub(nft.contract_address, token_id, receiver);
    stop_cheat_caller_address(mock_contract.contract_address);

    // Checks
    // get transaction
    let transaction = mock_contract.get_transaction_pub(tx_id);
    // check that the transaction type is type NFT_SEND
...
// fn test_propose_transaction_fail_if_nft_contract_zero() {
//     let mock_contract = deploy_mock_contract();
//     let token_id: u256 = 1;
//     let caller: ContractAddress = owner();
//     let receiver: ContractAddress = recipient();
...
//     // Propose Transaction
//     mock_contract
//         .propose_nft_transaction_pub(contract_address_const::<0>(), token_id, receiver); //
//         should panic
//     stop_cheat_caller_address(mock_contract.contract_address);
// }
...
//     // Propose Transaction
//     mock_contract
//         .propose_nft_transaction_pub(nft.contract_address, token_id,
//         contract_address_const::<0>()); // should panic
//     stop_cheat_caller_address(mock_contract.contract_address);
// }
